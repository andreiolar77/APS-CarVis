...
def region_of_interest(frame):
    ...
    polygon = np.array([[
        (int(width*0.2), height*0.6),              # Bottom-left point
        (int(width*0.4),  int(height*0.4)),   # Top-left point
        (int(width*0.5), int(height*0.4)),    # Top-right point
        (int(width*0.7), height*0.6),              # Bottom-right point
    ]], int)
...
def warp_perspective(frame):
    ...
    source_points = np.float32([[int(width*0.4), int(height*0.4)], # Top-left point
                      [int(width*0.5), int(height*0.4)],           # Top-right point
                      [int(width*0.2), height*0.6],                     # Bottom-left point
                      [int(width*0.7), height*0.6]])                    # Bottom-right point
...
def map_coordinates(frame, parameters):
    ...
    y2 = int(height*0.4)  # Make point from middle of the frame down  
